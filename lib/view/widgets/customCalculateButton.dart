...
import 'package:bmicalculator/controller/calculate.dart';
            ...
            return Container(
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    customText(text: calculator.getStatus(),color: calculator.getTextColor(),size:25),
...
Text customText({String? text, double? size,Color? color}) {
  return Text(
    text!,
    style: TextStyle(fontSize: size, color: color ?? Colors.white,),
